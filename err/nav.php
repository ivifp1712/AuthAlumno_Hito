...
<style>
    ...
    <nav>
        ...
        <a href="../crud.php">Administrador</a>
        <div class="login">
            <?php
            ...
            if (isset($_SESSION["user"])) {
                ...
                echo('<button class="btn btn-block btn-secondary" id="logOut" style="width: 100px"><i class="fa fa-sign-out"></i><span>Logout</span></button>');
                echo("</div>");
